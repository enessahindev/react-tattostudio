        ...
        <div className="flex flex-col xl:flex-row gap-y-16">
          ...
          >
            <form className="flex flex-col gap-y-10 w-full">
              <input
                className="border-b border-dark placeholder:text-[#555] italic tracking-[0.06em] outline-none pb-4 bg-gray-100"
                type="text"
              ...
              />
              <input
                className="border-b border-dark placeholder:text-[#555] italic tracking-[0.06em] outline-none pb-4 xl:mb-[30px] bg-gray-100"
                type="text"
